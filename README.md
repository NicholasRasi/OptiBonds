...
### 4. Max YTM Capital (Capital Efficiency)
...
If you want to see the cash flows of your portfolio, you can run the calculator with the `--cashflows` flag:
```bash
poetry run python calculator.py --cashflows
```
